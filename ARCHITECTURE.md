...
Neue Dekorationen oder Actor-Renderer werden zuerst im gemeinsamen Format und Renderer ergänzt. Der Editor stellt anschließend nur die benötigten Eingabefelder bereit. Reine Werkzeuge gehören in eigene Module und benötigen Node-Tests; sichtbare Abläufe erhalten zusätzlich einen Chromium-End-to-End-Test.
